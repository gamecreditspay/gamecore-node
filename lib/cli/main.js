...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `gamecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ gamecore-node add wallet-service');
      console.log('    $ gamecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ gamecore-node remove wallet-service');
      console.log('    $ gamecore-node remove insight-api');
      console.log();
    });
